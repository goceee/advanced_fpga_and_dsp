; ModuleID = 'C:/Xilinx/workspace_sdx/lab_2/src/madd.cpp'
source_filename = "C:/Xilinx/workspace_sdx/lab_2/src/madd.cpp"
target datalayout = "e-m:e-p:32:32-i64:64-v128:64:128-a:0:32-n32-S64"
target triple = "armv7-none--eabi"

; Function Attrs: nounwind
define void @_Z4maddPfS_S_(float*, float*, float*) #0 !dbg !242 !xidane.fname !247 !xidane.function_argument_annotation !248 !xidane.function_declaration_type !249 !xidane.function_declaration_filename !250 {
  ...
  call void @llvm.dbg.declare(metadata i32* %7, metadata !258, metadata !252), !dbg !259
  call void @llvm.dbg.declare(metadata i32* %8, metadata !260, metadata !252), !dbg !261
  store i32 0, i32* %7, align 4, !dbg !262
  br label %9, !dbg !264

; <label>:9:                                      ; preds = %42, %3
  %10 = load i32, i32* %7, align 4, !dbg !265
  %11 = icmp slt i32 %10, 32, !dbg !268
  br i1 %11, label %12, label %45, !dbg !269

; <label>:12:                                     ; preds = %9
  store i32 0, i32* %8, align 4, !dbg !270
  br label %13, !dbg !272

; <label>:13:                                     ; preds = %38, %12
  %14 = load i32, i32* %8, align 4, !dbg !273
  %15 = icmp slt i32 %14, 32, !dbg !276
  br i1 %15, label %16, label %41, !dbg !277

; <label>:16:                                     ; preds = %13
  %17 = load i32, i32* %7, align 4, !dbg !278
  %18 = mul nsw i32 %17, 32, !dbg !279
  %19 = load i32, i32* %8, align 4, !dbg !280
  %20 = add nsw i32 %18, %19, !dbg !281
  %21 = load float*, float** %4, align 4, !dbg !282
  %22 = getelementptr inbounds float, float* %21, i32 %20, !dbg !282
  %23 = load float, float* %22, align 4, !dbg !282
  %24 = load i32, i32* %7, align 4, !dbg !283
  %25 = mul nsw i32 %24, 32, !dbg !284
  %26 = load i32, i32* %8, align 4, !dbg !285
  %27 = add nsw i32 %25, %26, !dbg !286
  %28 = load float*, float** %5, align 4, !dbg !287
  %29 = getelementptr inbounds float, float* %28, i32 %27, !dbg !287
  %30 = load float, float* %29, align 4, !dbg !287
  %31 = fadd float %23, %30, !dbg !288
  %32 = load i32, i32* %7, align 4, !dbg !289
  %33 = mul nsw i32 %32, 32, !dbg !290
  %34 = load i32, i32* %8, align 4, !dbg !291
  %35 = add nsw i32 %33, %34, !dbg !292
  %36 = load float*, float** %6, align 4, !dbg !293
  %37 = getelementptr inbounds float, float* %36, i32 %35, !dbg !293
  store float %31, float* %37, align 4, !dbg !294
  br label %38, !dbg !293

; <label>:38:                                     ; preds = %16
  %39 = load i32, i32* %8, align 4, !dbg !295
  %40 = add nsw i32 %39, 1, !dbg !295
  store i32 %40, i32* %8, align 4, !dbg !295
  br label %13, !dbg !297, !llvm.loop !298

; <label>:41:                                     ; preds = %13
  br label %42, !dbg !300

; <label>:42:                                     ; preds = %41
  %43 = load i32, i32* %7, align 4, !dbg !302
  %44 = add nsw i32 %43, 1, !dbg !302
  store i32 %44, i32* %7, align 4, !dbg !302
  br label %9, !dbg !304, !llvm.loop !305
...
!1 = !DIFile(filename: "../src\5Cmadd.cpp", directory: "C:\5CXilinx\5Cworkspace_sdx\5Clab_2\5CRelease")
!2 = !{}
...
!243 = !DIFile(filename: "C:/Xilinx/workspace_sdx/lab_2/src/madd.cpp", directory: "C:\5CXilinx\5Cworkspace_sdx\5Clab_2\5CRelease")
...
!250 = !{!"../src/mmultadd.h"}
!251 = !DILocalVariable(name: "A", arg: 1, scope: !242, file: !243, line: 43, type: !246)
!252 = !DIExpression()
!253 = !DILocation(line: 43, column: 17, scope: !242)
!254 = !DILocalVariable(name: "B", arg: 2, scope: !242, file: !243, line: 43, type: !246)
!255 = !DILocation(line: 43, column: 33, scope: !242)
!256 = !DILocalVariable(name: "C", arg: 3, scope: !242, file: !243, line: 43, type: !246)
!257 = !DILocation(line: 43, column: 49, scope: !242)
!258 = !DILocalVariable(name: "i", scope: !242, file: !243, line: 45, type: !11)
!259 = !DILocation(line: 45, column: 9, scope: !242)
!260 = !DILocalVariable(name: "j", scope: !242, file: !243, line: 45, type: !11)
!261 = !DILocation(line: 45, column: 12, scope: !242)
!262 = !DILocation(line: 47, column: 12, scope: !263)
!263 = distinct !DILexicalBlock(scope: !242, file: !243, line: 47, column: 5)
!264 = !DILocation(line: 47, column: 10, scope: !263)
!265 = !DILocation(line: 47, column: 17, scope: !266)
!266 = !DILexicalBlockFile(scope: !267, file: !243, discriminator: 1)
!267 = distinct !DILexicalBlock(scope: !263, file: !243, line: 47, column: 5)
!268 = !DILocation(line: 47, column: 19, scope: !266)
!269 = !DILocation(line: 47, column: 5, scope: !266)
!270 = !DILocation(line: 48, column: 16, scope: !271)
!271 = distinct !DILexicalBlock(scope: !267, file: !243, line: 48, column: 9)
!272 = !DILocation(line: 48, column: 14, scope: !271)
!273 = !DILocation(line: 48, column: 21, scope: !274)
!274 = !DILexicalBlockFile(scope: !275, file: !243, discriminator: 1)
!275 = distinct !DILexicalBlock(scope: !271, file: !243, line: 48, column: 9)
!276 = !DILocation(line: 48, column: 23, scope: !274)
!277 = !DILocation(line: 48, column: 9, scope: !274)
!278 = !DILocation(line: 50, column: 30, scope: !275)
!279 = !DILocation(line: 50, column: 32, scope: !275)
!280 = !DILocation(line: 50, column: 38, scope: !275)
!281 = !DILocation(line: 50, column: 36, scope: !275)
!282 = !DILocation(line: 50, column: 28, scope: !275)
!283 = !DILocation(line: 50, column: 45, scope: !275)
!284 = !DILocation(line: 50, column: 47, scope: !275)
!285 = !DILocation(line: 50, column: 53, scope: !275)
!286 = !DILocation(line: 50, column: 51, scope: !275)
!287 = !DILocation(line: 50, column: 43, scope: !275)
!288 = !DILocation(line: 50, column: 41, scope: !275)
!289 = !DILocation(line: 50, column: 15, scope: !275)
!290 = !DILocation(line: 50, column: 17, scope: !275)
!291 = !DILocation(line: 50, column: 23, scope: !275)
!292 = !DILocation(line: 50, column: 21, scope: !275)
!293 = !DILocation(line: 50, column: 13, scope: !275)
!294 = !DILocation(line: 50, column: 26, scope: !275)
!295 = !DILocation(line: 48, column: 29, scope: !296)
!296 = !DILexicalBlockFile(scope: !275, file: !243, discriminator: 2)
!297 = !DILocation(line: 48, column: 9, scope: !296)
!298 = distinct !{!298, !299}
!299 = !DILocation(line: 48, column: 9, scope: !267)
!300 = !DILocation(line: 50, column: 54, scope: !301)
!301 = !DILexicalBlockFile(scope: !271, file: !243, discriminator: 1)
!302 = !DILocation(line: 47, column: 25, scope: !303)
!303 = !DILexicalBlockFile(scope: !267, file: !243, discriminator: 2)
!304 = !DILocation(line: 47, column: 5, scope: !303)
!305 = distinct !{!305, !306}
!306 = !DILocation(line: 47, column: 5, scope: !242)
!307 = !DILocation(line: 51, column: 1, scope: !242)
