; ModuleID = 'C:/Users/nh15775/workspace/lab_2/src/main.cpp'
source_filename = "C:/Users/nh15775/workspace/lab_2/src/main.cpp"
...
; <label>:45:                                     ; preds = %42
  ...
  call void @sds_free(i8* %47), !dbg !1509
  br label %48, !dbg !1509

; <label>:48:                                     ; preds = %45, %42
  %49 = load float*, float** %9, align 4, !dbg !1510
  %50 = icmp ne float* %49, null, !dbg !1510
  br i1 %50, label %51, label %54, !dbg !1512

; <label>:51:                                     ; preds = %48
  %52 = load float*, float** %9, align 4, !dbg !1513
  %53 = bitcast float* %52 to i8*, !dbg !1513
  call void @sds_free(i8* %53), !dbg !1515
  br label %54, !dbg !1515

; <label>:54:                                     ; preds = %51, %48
  %55 = load float*, float** %10, align 4, !dbg !1516
  %56 = icmp ne float* %55, null, !dbg !1516
  br i1 %56, label %57, label %60, !dbg !1518

; <label>:57:                                     ; preds = %54
  %58 = load float*, float** %10, align 4, !dbg !1519
  %59 = bitcast float* %58 to i8*, !dbg !1519
  call void @sds_free(i8* %59), !dbg !1521
  br label %60, !dbg !1521

; <label>:60:                                     ; preds = %57, %54
  %61 = load float*, float** %11, align 4, !dbg !1522
  %62 = icmp ne float* %61, null, !dbg !1522
  br i1 %62, label %63, label %66, !dbg !1524

; <label>:63:                                     ; preds = %60
  %64 = load float*, float** %11, align 4, !dbg !1525
  %65 = bitcast float* %64 to i8*, !dbg !1525
  call void @free(i8* %65) #3, !dbg !1527
  br label %66, !dbg !1527

; <label>:66:                                     ; preds = %63, %60
  store i32 2, i32* %3, align 4, !dbg !1528
  br label %97, !dbg !1528

; <label>:67:                                     ; preds = %33
  %68 = load float*, float** %7, align 4, !dbg !1529
  %69 = load float*, float** %8, align 4, !dbg !1530
  %70 = load float*, float** %9, align 4, !dbg !1531
  %71 = load float*, float** %10, align 4, !dbg !1532
  %72 = load float*, float** %11, align 4, !dbg !1533
  %73 = call i32 @_Z10mmult_testPfS_S_S_S_(float* %68, float* %69, float* %70, float* %71, float* %72), !dbg !1534
  store i32 %73, i32* %6, align 4, !dbg !1535
  %74 = call dereferenceable(140) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(140) @_ZSt4cout, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.7, i32 0, i32 0)), !dbg !1536
  %75 = load i32, i32* %6, align 4, !dbg !1537
  %76 = icmp ne i32 %75, 0, !dbg !1537
  br i1 %76, label %77, label %78, !dbg !1537

; <label>:77:                                     ; preds = %67
  br label %79, !dbg !1538

; <label>:78:                                     ; preds = %67
  br label %79, !dbg !1540

; <label>:79:                                     ; preds = %78, %77
  %80 = phi [7 x i8]* [ @.str.8, %77 ], [ @.str.9, %78 ], !dbg !1542
  %81 = getelementptr inbounds [7 x i8], [7 x i8]* %80, i32 0, i32 0, !dbg !1544
  %82 = call dereferenceable(140) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(140) %74, i8* %81), !dbg !1545
  %83 = call dereferenceable(140) %"class.std::basic_ostream"* @_ZNSolsEPFRSoS_E(%"class.std::basic_ostream"* %82, %"class.std::basic_ostream"* (%"class.std::basic_ostream"*)* @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_), !dbg !1546
  %84 = load float*, float** %7, align 4, !dbg !1548
  %85 = bitcast float* %84 to i8*, !dbg !1548
  call void @sds_free(i8* %85), !dbg !1549
  %86 = load float*, float** %8, align 4, !dbg !1550
  %87 = bitcast float* %86 to i8*, !dbg !1550
  call void @sds_free(i8* %87), !dbg !1551
  %88 = load float*, float** %9, align 4, !dbg !1552
  %89 = bitcast float* %88 to i8*, !dbg !1552
  call void @sds_free(i8* %89), !dbg !1553
  %90 = load float*, float** %10, align 4, !dbg !1554
  %91 = bitcast float* %90 to i8*, !dbg !1554
  call void @sds_free(i8* %91), !dbg !1555
  %92 = load float*, float** %11, align 4, !dbg !1556
  %93 = bitcast float* %92 to i8*, !dbg !1556
  call void @free(i8* %93) #3, !dbg !1557
  %94 = load i32, i32* %6, align 4, !dbg !1558
  %95 = icmp ne i32 %94, 0, !dbg !1558
  %96 = select i1 %95, i32 -1, i32 0, !dbg !1558
  store i32 %96, i32* %3, align 4, !dbg !1559
  br label %97, !dbg !1559

; <label>:97:                                     ; preds = %79, %66
  %98 = load i32, i32* %3, align 4, !dbg !1560
  ret i32 %98, !dbg !1560
}

declare !xidane.fname !1561 !xidane.function_declaration_type !1562 !xidane.function_declaration_filename !1563 !xidane.ExternC !1564 i8* @sds_alloc(i32) #1

; Function Attrs: nounwind
declare !xidane.fname !1565 !xidane.function_declaration_type !1566 !xidane.function_declaration_filename !1567 !xidane.ExternC !1564 i8* @malloc(i32) #2

declare !xidane.fname !1568 !xidane.function_declaration_type !1569 !xidane.function_declaration_filename !1563 !xidane.ExternC !1564 void @sds_free(i8*) #1

; Function Attrs: nounwind
declare !xidane.fname !1570 !xidane.function_declaration_type !1569 !xidane.function_declaration_filename !1567 !xidane.ExternC !1564 void @free(i8*) #2

declare !xidane.fname !1571 !xidane.function_declaration_type !1572 !xidane.function_declaration_filename !1567 !xidane.ExternC !1564 i32 @rand() #1

declare !xidane.fname !1573 !xidane.function_declaration_type !1574 !xidane.function_declaration_filename !1563 !xidane.ExternC !1564 i64 @sds_clock_counter() #1

declare !xidane.fname !1255 !xidane.function_declaration_type !1575 !xidane.function_declaration_filename !1254 dereferenceable(140) %"class.std::basic_ostream"* @_ZNSolsEf(%"class.std::basic_ostream"*, float) #1

define internal void @_GLOBAL__sub_I_main.cpp() #0 !dbg !1576 {
  call void @__cxx_global_var_init(), !dbg !1578
  ret void
}
...
!1 = !DIFile(filename: "../src\5Cmain.cpp", directory: "C:\5CUsers\5Cnh15775\5Cworkspace\5Clab_2\5CRelease")
!2 = !{}
!3 = !{!4, !5}
...
!10 = !DIFile(filename: "C:/Xilinx/SDK/2018.2/gnu/aarch32/nt/gcc-arm-none-eabi/arm-none-eabi/include/c++/7.2.1/arm-none-eabi\5Cbits/c++config.h", directory: "C:\5CUsers\5Cnh15775\5Cworkspace\5Clab_2\5CRelease")
!11 = !DIFile(filename: "C:/Xilinx/SDK/2018.2/gnu/aarch32/nt/gcc-arm-none-eabi/arm-none-eabi/include/c++/7.2.1\5Ciostream", directory: "C:\5CUsers\5Cnh15775\5Cworkspace\5Clab_2\5CRelease")
...
!13 = !DIFile(filename: "C:/Xilinx/SDK/2018.2/gnu/aarch32/nt/gcc-arm-none-eabi/arm-none-eabi/include/c++/7.2.1\5Cbits/ios_base.h", directory: "C:\5CUsers\5Cnh15775\5Cworkspace\5Clab_2\5CRelease")
...
!18 = !DIFile(filename: "C:/Xilinx/SDK/2018.2/gnu/aarch32/nt/gcc-arm-none-eabi/arm-none-eabi/include/c++/7.2.1/arm-none-eabi\5Cbits/atomic_word.h", directory: "C:\5CUsers\5Cnh15775\5Cworkspace\5Clab_2\5CRelease")
...
!30 = !DIFile(filename: "C:/Xilinx/SDK/2018.2/gnu/aarch32/nt/gcc-arm-none-eabi/arm-none-eabi/libc/usr/include\5Cwchar.h", directory: "C:\5CUsers\5Cnh15775\5Cworkspace\5Clab_2\5CRelease")
!31 = !DIDerivedType(tag: DW_TAG_typedef, name: "_mbstate_t", file: !32, line: 79, baseType: !33)
!32 = !DIFile(filename: "C:/Xilinx/SDK/2018.2/gnu/aarch32/nt/gcc-arm-none-eabi/arm-none-eabi/libc/usr/include\5Csys/_types.h", directory: "C:\5CUsers\5Cnh15775\5Cworkspace\5Clab_2\5CRelease")
...
!41 = !DIFile(filename: "C:/Xilinx/SDK/2018.2/gnu/aarch32/nt/gcc-arm-none-eabi/lib/gcc/arm-none-eabi/7.2.1/include\5Cstddef.h", directory: "C:\5CUsers\5Cnh15775\5Cworkspace\5Clab_2\5CRelease")
...
!58 = !DIFile(filename: "C:/Xilinx/SDK/2018.2/gnu/aarch32/nt/gcc-arm-none-eabi/arm-none-eabi/libc/usr/include\5Csys/reent.h", directory: "C:\5CUsers\5Cnh15775\5Cworkspace\5Clab_2\5CRelease")
...
!119 = !DIFile(filename: "C:/Xilinx/SDK/2018.2/gnu/aarch32/nt/gcc-arm-none-eabi/arm-none-eabi/libc/usr/include\5Csys/lock.h", directory: "C:\5CUsers\5Cnh15775\5Cworkspace\5Clab_2\5CRelease")
...
!199 = !DIFile(filename: "C:/Xilinx/SDK/2018.2/gnu/aarch32/nt/gcc-arm-none-eabi/lib/gcc/arm-none-eabi/7.2.1/include\5Cstdarg.h", directory: "C:\5CUsers\5Cnh15775\5Cworkspace\5Clab_2\5CRelease")
...
!359 = !DIFile(filename: "C:/Xilinx/SDK/2018.2/gnu/aarch32/nt/gcc-arm-none-eabi/arm-none-eabi/include/c++/7.2.1\5Cbits/exception_ptr.h", directory: "C:\5CUsers\5Cnh15775\5Cworkspace\5Clab_2\5CRelease")
...
!410 = !DIFile(filename: "C:/Xilinx/SDK/2018.2/gnu/aarch32/nt/gcc-arm-none-eabi/arm-none-eabi/include/c++/7.2.1\5Ctypeinfo", directory: "C:\5CUsers\5Cnh15775\5Cworkspace\5Clab_2\5CRelease")
...
!417 = !DIFile(filename: "C:/Xilinx/SDK/2018.2/gnu/aarch32/nt/gcc-arm-none-eabi/arm-none-eabi/include/c++/7.2.1\5Cdebug/debug.h", directory: "C:\5CUsers\5Cnh15775\5Cworkspace\5Clab_2\5CRelease")
...
!421 = !DIFile(filename: "C:/Xilinx/SDK/2018.2/gnu/aarch32/nt/gcc-arm-none-eabi/arm-none-eabi/libc/usr/include\5Csys/_stdint.h", directory: "C:\5CUsers\5Cnh15775\5Cworkspace\5Clab_2\5CRelease")
!422 = !DIDerivedType(tag: DW_TAG_typedef, name: "__int8_t", file: !423, line: 27, baseType: !424)
!423 = !DIFile(filename: "C:/Xilinx/SDK/2018.2/gnu/aarch32/nt/gcc-arm-none-eabi/arm-none-eabi/libc/usr/include\5Cmachine/_default_types.h", directory: "C:\5CUsers\5Cnh15775\5Cworkspace\5Clab_2\5CRelease")
...
!436 = !DIFile(filename: "C:/Xilinx/SDK/2018.2/gnu/aarch32/nt/gcc-arm-none-eabi/arm-none-eabi/libc/usr/include\5Cstdint.h", directory: "C:\5CUsers\5Cnh15775\5Cworkspace\5Clab_2\5CRelease")
...
!500 = !DIFile(filename: "C:/Xilinx/SDK/2018.2/gnu/aarch32/nt/gcc-arm-none-eabi/arm-none-eabi/libc/usr/include\5Clocale.h", directory: "C:\5CUsers\5Cnh15775\5Cworkspace\5Clab_2\5CRelease")
...
!512 = !DIFile(filename: "C:/Xilinx/SDK/2018.2/gnu/aarch32/nt/gcc-arm-none-eabi/arm-none-eabi/libc/usr/include\5Cctype.h", directory: "C:\5CUsers\5Cnh15775\5Cworkspace\5Clab_2\5CRelease")
...
!547 = !DIFile(filename: "C:/Xilinx/SDK/2018.2/gnu/aarch32/nt/gcc-arm-none-eabi/arm-none-eabi/libc/usr/include\5Cstdlib.h", directory: "C:\5CUsers\5Cnh15775\5Cworkspace\5Clab_2\5CRelease")
...
!712 = !DIFile(filename: "C:/Xilinx/SDK/2018.2/gnu/aarch32/nt/gcc-arm-none-eabi/arm-none-eabi/include/c++/7.2.1\5Ccstdlib", directory: "C:\5CUsers\5Cnh15775\5Cworkspace\5Clab_2\5CRelease")
...
!723 = !DIFile(filename: "C:/Xilinx/SDK/2018.2/gnu/aarch32/nt/gcc-arm-none-eabi/arm-none-eabi/libc/usr/include\5Cstdio.h", directory: "C:\5CUsers\5Cnh15775\5Cworkspace\5Clab_2\5CRelease")
...
!885 = !DIFile(filename: "C:/Xilinx/SDK/2018.2/gnu/aarch32/nt/gcc-arm-none-eabi/arm-none-eabi/libc/usr/include\5Cwctype.h", directory: "C:\5CUsers\5Cnh15775\5Cworkspace\5Clab_2\5CRelease")
...
!942 = !DIFile(filename: "C:/Xilinx/SDK/2018.2/gnu/aarch32/nt/gcc-arm-none-eabi/arm-none-eabi/include/c++/7.2.1\5Cbits/std_abs.h", directory: "C:\5CUsers\5Cnh15775\5Cworkspace\5Clab_2\5CRelease")
...
!983 = !DIFile(filename: "C:/Users/nh15775/workspace/lab_2/src/main.cpp", directory: "C:\5CUsers\5Cnh15775\5Cworkspace\5Clab_2\5CRelease")
!984 = !DISubroutineType(types: !985)
!985 = !{null, !5, !5, !5}
!986 = !{!"mmult_golden"}
!987 = !{!"void.float *.1.float *.1.float *.1"}
!988 = !{!"C:/Users/nh15775/workspace/lab_2/src/main.cpp"}
...
!1380 = !{!"madd"}
!1381 = distinct !DISubprogram(name: "result_check", linkageName: "_ZL12result_checkPfS_", scope: !983, file: !983, line: 95, type: !1382, isLocal: true, isDefinition: true, scopeLine: 96, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2)
!1382 = !DISubroutineType(types: !1383)
!1383 = !{!19, !5, !5}
!1384 = !{!"result_check"}
!1385 = !{!"int.float *.1.float *.1"}
!1386 = !DILocalVariable(name: "D", arg: 1, scope: !1381, file: !983, line: 95, type: !5)
!1387 = !DILocation(line: 95, column: 32, scope: !1381)
!1388 = !DILocalVariable(name: "D_sw", arg: 2, scope: !1381, file: !983, line: 95, type: !5)
!1389 = !DILocation(line: 95, column: 42, scope: !1381)
!1390 = !DILocalVariable(name: "i", scope: !1391, file: !983, line: 97, type: !19)
!1391 = distinct !DILexicalBlock(scope: !1381, file: !983, line: 97, column: 6)
!1392 = !DILocation(line: 97, column: 15, scope: !1391)
!1393 = !DILocation(line: 97, column: 11, scope: !1391)
!1394 = !DILocation(line: 97, column: 22, scope: !1395)
!1395 = !DILexicalBlockFile(scope: !1396, file: !983, discriminator: 1)
!1396 = distinct !DILexicalBlock(scope: !1391, file: !983, line: 97, column: 6)
!1397 = !DILocation(line: 97, column: 24, scope: !1395)
!1398 = !DILocation(line: 97, column: 6, scope: !1395)
!1399 = !DILocation(line: 98, column: 20, scope: !1400)
!1400 = distinct !DILexicalBlock(scope: !1401, file: !983, line: 98, column: 15)
!1401 = distinct !DILexicalBlock(scope: !1396, file: !983, line: 97, column: 38)
!1402 = !DILocation(line: 98, column: 15, scope: !1400)
!1403 = !DILocation(line: 98, column: 28, scope: !1400)
!1404 = !DILocation(line: 98, column: 26, scope: !1400)
!1405 = !DILocation(line: 98, column: 23, scope: !1400)
!1406 = !DILocation(line: 98, column: 15, scope: !1401)
!1407 = !DILocation(line: 99, column: 26, scope: !1408)
!1408 = distinct !DILexicalBlock(scope: !1400, file: !983, line: 98, column: 32)
!1409 = !DILocation(line: 99, column: 56, scope: !1408)
!1410 = !DILocation(line: 99, column: 53, scope: !1411)
!1411 = !DILexicalBlockFile(scope: !1408, file: !983, discriminator: 1)
!1412 = !DILocation(line: 99, column: 58, scope: !1413)
!1413 = !DILexicalBlockFile(scope: !1408, file: !983, discriminator: 2)
!1414 = !DILocation(line: 99, column: 74, scope: !1408)
!1415 = !DILocation(line: 99, column: 69, scope: !1408)
!1416 = !DILocation(line: 99, column: 66, scope: !1417)
!1417 = !DILexicalBlockFile(scope: !1408, file: !983, discriminator: 3)
!1418 = !DILocation(line: 100, column: 25, scope: !1408)
!1419 = !DILocation(line: 100, column: 43, scope: !1408)
!1420 = !DILocation(line: 100, column: 41, scope: !1408)
!1421 = !DILocation(line: 100, column: 38, scope: !1411)
!1422 = !DILocation(line: 100, column: 46, scope: !1413)
!1423 = !DILocation(line: 101, column: 16, scope: !1408)
!1424 = !DILocation(line: 103, column: 6, scope: !1401)
!1425 = !DILocation(line: 97, column: 34, scope: !1426)
!1426 = !DILexicalBlockFile(scope: !1396, file: !983, discriminator: 2)
!1427 = !DILocation(line: 97, column: 6, scope: !1426)
!1428 = distinct !{!1428, !1429}
!1429 = !DILocation(line: 97, column: 6, scope: !1381)
!1430 = !DILocation(line: 104, column: 6, scope: !1381)
!1431 = !DILocation(line: 105, column: 1, scope: !1381)
!1432 = distinct !DISubprogram(name: "avg_cpu_cycles", linkageName: "_ZN12perf_counter14avg_cpu_cyclesEv", scope: !1153, file: !983, line: 57, type: !1166, isLocal: false, isDefinition: true, scopeLine: 57, flags: DIFlagPrototyped, isOptimized: false, unit: !0, declaration: !1165, variables: !2)
!1433 = !{!"avg_cpu_cycles"}
!1434 = !{!"uint64_t."}
...
!1437 = !DILocation(line: 57, column: 50, scope: !1432)
!1438 = !DILocation(line: 57, column: 55, scope: !1432)
!1439 = !DILocation(line: 57, column: 60, scope: !1432)
!1440 = !DILocation(line: 57, column: 53, scope: !1432)
!1441 = !DILocation(line: 57, column: 68, scope: !1432)
!1442 = !DILocation(line: 57, column: 66, scope: !1432)
!1443 = !DILocation(line: 57, column: 41, scope: !1432)
!1444 = !{!"__ostream_type .unsigned long long.0"}
!1445 = !{!"__ostream_type .double.0"}
!1446 = distinct !DISubprogram(name: "main", scope: !983, file: !983, line: 146, type: !1447, isLocal: false, isDefinition: true, scopeLine: 146, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2)
!1447 = !DISubroutineType(types: !1448)
!1448 = !{!19, !19, !652}
!1449 = !{!"main"}
!1450 = !{!"int.int.0.char *[].1"}
!1451 = !DILocalVariable(name: "argc", arg: 1, scope: !1446, file: !983, line: 146, type: !19)
!1452 = !DILocation(line: 146, column: 14, scope: !1446)
!1453 = !DILocalVariable(name: "argv", arg: 2, scope: !1446, file: !983, line: 146, type: !652)
!1454 = !DILocation(line: 146, column: 26, scope: !1446)
!1455 = !DILocalVariable(name: "test_passed", scope: !1446, file: !983, line: 147, type: !19)
!1456 = !DILocation(line: 147, column: 10, scope: !1446)
!1457 = !DILocalVariable(name: "A", scope: !1446, file: !983, line: 148, type: !5)
!1458 = !DILocation(line: 148, column: 13, scope: !1446)
!1459 = !DILocalVariable(name: "B", scope: !1446, file: !983, line: 148, type: !5)
!1460 = !DILocation(line: 148, column: 17, scope: !1446)
!1461 = !DILocalVariable(name: "C", scope: !1446, file: !983, line: 148, type: !5)
!1462 = !DILocation(line: 148, column: 21, scope: !1446)
!1463 = !DILocalVariable(name: "D", scope: !1446, file: !983, line: 148, type: !5)
!1464 = !DILocation(line: 148, column: 25, scope: !1446)
!1465 = !DILocalVariable(name: "D_sw", scope: !1446, file: !983, line: 148, type: !5)
!1466 = !DILocation(line: 148, column: 29, scope: !1446)
!1467 = !DILocation(line: 150, column: 19, scope: !1446)
!1468 = !DILocation(line: 150, column: 10, scope: !1446)
!1469 = !DILocation(line: 150, column: 8, scope: !1446)
!1470 = !DILocation(line: 151, column: 19, scope: !1446)
!1471 = !DILocation(line: 151, column: 10, scope: !1446)
!1472 = !DILocation(line: 151, column: 8, scope: !1446)
!1473 = !DILocation(line: 152, column: 19, scope: !1446)
!1474 = !DILocation(line: 152, column: 10, scope: !1446)
!1475 = !DILocation(line: 152, column: 8, scope: !1446)
!1476 = !DILocation(line: 153, column: 19, scope: !1446)
!1477 = !DILocation(line: 153, column: 10, scope: !1446)
!1478 = !DILocation(line: 153, column: 8, scope: !1446)
!1479 = !DILocation(line: 154, column: 22, scope: !1446)
!1480 = !DILocation(line: 154, column: 13, scope: !1446)
!1481 = !DILocation(line: 154, column: 11, scope: !1446)
!1482 = !DILocation(line: 156, column: 11, scope: !1483)
!1483 = distinct !DILexicalBlock(scope: !1446, file: !983, line: 156, column: 10)
!1484 = !DILocation(line: 156, column: 13, scope: !1483)
!1485 = !DILocation(line: 156, column: 17, scope: !1486)
!1486 = !DILexicalBlockFile(scope: !1483, file: !983, discriminator: 1)
!1487 = !DILocation(line: 156, column: 19, scope: !1486)
!1488 = !DILocation(line: 156, column: 23, scope: !1489)
!1489 = !DILexicalBlockFile(scope: !1483, file: !983, discriminator: 2)
!1490 = !DILocation(line: 156, column: 25, scope: !1489)
!1491 = !DILocation(line: 156, column: 29, scope: !1492)
!1492 = !DILexicalBlockFile(scope: !1483, file: !983, discriminator: 3)
!1493 = !DILocation(line: 156, column: 31, scope: !1492)
!1494 = !DILocation(line: 156, column: 35, scope: !1495)
!1495 = !DILexicalBlockFile(scope: !1483, file: !983, discriminator: 4)
!1496 = !DILocation(line: 156, column: 10, scope: !1495)
!1497 = !DILocation(line: 157, column: 15, scope: !1498)
!1498 = distinct !DILexicalBlock(scope: !1499, file: !983, line: 157, column: 15)
!1499 = distinct !DILexicalBlock(scope: !1483, file: !983, line: 156, column: 41)
!1500 = !DILocation(line: 157, column: 15, scope: !1499)
!1501 = !DILocation(line: 157, column: 27, scope: !1502)
!1502 = !DILexicalBlockFile(scope: !1498, file: !983, discriminator: 1)
!1503 = !DILocation(line: 157, column: 18, scope: !1502)
!1504 = !DILocation(line: 158, column: 15, scope: !1505)
!1505 = distinct !DILexicalBlock(scope: !1499, file: !983, line: 158, column: 15)
!1506 = !DILocation(line: 158, column: 15, scope: !1499)
!1507 = !DILocation(line: 158, column: 27, scope: !1508)
!1508 = !DILexicalBlockFile(scope: !1505, file: !983, discriminator: 1)
!1509 = !DILocation(line: 158, column: 18, scope: !1508)
!1510 = !DILocation(line: 159, column: 15, scope: !1511)
!1511 = distinct !DILexicalBlock(scope: !1499, file: !983, line: 159, column: 15)
!1512 = !DILocation(line: 159, column: 15, scope: !1499)
!1513 = !DILocation(line: 159, column: 27, scope: !1514)
!1514 = !DILexicalBlockFile(scope: !1511, file: !983, discriminator: 1)
!1515 = !DILocation(line: 159, column: 18, scope: !1514)
!1516 = !DILocation(line: 160, column: 15, scope: !1517)
!1517 = distinct !DILexicalBlock(scope: !1499, file: !983, line: 160, column: 15)
!1518 = !DILocation(line: 160, column: 15, scope: !1499)
!1519 = !DILocation(line: 160, column: 27, scope: !1520)
!1520 = !DILexicalBlockFile(scope: !1517, file: !983, discriminator: 1)
!1521 = !DILocation(line: 160, column: 18, scope: !1520)
!1522 = !DILocation(line: 161, column: 15, scope: !1523)
!1523 = distinct !DILexicalBlock(scope: !1499, file: !983, line: 161, column: 15)
!1524 = !DILocation(line: 161, column: 15, scope: !1499)
!1525 = !DILocation(line: 161, column: 26, scope: !1526)
!1526 = !DILexicalBlockFile(scope: !1523, file: !983, discriminator: 1)
!1527 = !DILocation(line: 161, column: 21, scope: !1526)
!1528 = !DILocation(line: 162, column: 11, scope: !1499)
!1529 = !DILocation(line: 165, column: 31, scope: !1446)
!1530 = !DILocation(line: 165, column: 34, scope: !1446)
!1531 = !DILocation(line: 165, column: 37, scope: !1446)
!1532 = !DILocation(line: 165, column: 40, scope: !1446)
!1533 = !DILocation(line: 165, column: 43, scope: !1446)
!1534 = !DILocation(line: 165, column: 20, scope: !1446)
!1535 = !DILocation(line: 165, column: 18, scope: !1446)
!1536 = !DILocation(line: 167, column: 16, scope: !1446)
!1537 = !DILocation(line: 167, column: 31, scope: !1446)
!1538 = !DILocation(line: 167, column: 31, scope: !1539)
!1539 = !DILexicalBlockFile(scope: !1446, file: !983, discriminator: 1)
!1540 = !DILocation(line: 167, column: 31, scope: !1541)
!1541 = !DILexicalBlockFile(scope: !1446, file: !983, discriminator: 2)
!1542 = !DILocation(line: 167, column: 31, scope: !1543)
!1543 = !DILexicalBlockFile(scope: !1446, file: !983, discriminator: 3)
!1544 = !DILocation(line: 167, column: 30, scope: !1543)
!1545 = !DILocation(line: 167, column: 27, scope: !1543)
!1546 = !DILocation(line: 167, column: 66, scope: !1547)
!1547 = !DILexicalBlockFile(scope: !1543, file: !983, discriminator: 4)
!1548 = !DILocation(line: 169, column: 15, scope: !1446)
!1549 = !DILocation(line: 169, column: 6, scope: !1446)
!1550 = !DILocation(line: 170, column: 15, scope: !1446)
!1551 = !DILocation(line: 170, column: 6, scope: !1446)
!1552 = !DILocation(line: 171, column: 15, scope: !1446)
!1553 = !DILocation(line: 171, column: 6, scope: !1446)
!1554 = !DILocation(line: 172, column: 15, scope: !1446)
!1555 = !DILocation(line: 172, column: 6, scope: !1446)
!1556 = !DILocation(line: 173, column: 11, scope: !1446)
!1557 = !DILocation(line: 173, column: 6, scope: !1446)
!1558 = !DILocation(line: 175, column: 14, scope: !1446)
!1559 = !DILocation(line: 175, column: 6, scope: !1446)
!1560 = !DILocation(line: 176, column: 1, scope: !1446)
!1561 = !{!"sds_alloc"}
!1562 = !{!"void .unsigned int.0"}
!1563 = !{!"C:/Xilinx/SDx/2018.2/target/aarch32-none/include\5Csds_lib.h"}
!1564 = !{!"t"}
!1565 = !{!"malloc"}
!1566 = !{!"void .size_t.0"}
!1567 = !{!"C:/Xilinx/SDK/2018.2/gnu/aarch32/nt/gcc-arm-none-eabi/arm-none-eabi/libc/usr/include\5Cstdlib.h"}
!1568 = !{!"sds_free"}
!1569 = !{!"void.void *.1"}
!1570 = !{!"free"}
!1571 = !{!"rand"}
!1572 = !{!"int."}
!1573 = !{!"sds_clock_counter"}
!1574 = !{!"unsigned long long."}
!1575 = !{!"__ostream_type .float.0"}
!1576 = distinct !DISubprogram(linkageName: "_GLOBAL__sub_I_main.cpp", scope: !1, file: !1, type: !1577, isLocal: true, isDefinition: true, flags: DIFlagArtificial, isOptimized: false, unit: !0, variables: !2)
!1577 = !DISubroutineType(types: !2)
