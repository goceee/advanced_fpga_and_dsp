...
HD_PWD='C:/Users/Naimu/workspace/lab_2/Release/_sds/p0/vivado/prj/prj.runs/zed_block_mmult_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zed_block_mmult_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zed_block_mmult_1_0.tcl
