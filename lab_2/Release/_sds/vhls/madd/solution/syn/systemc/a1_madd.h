...
#include "a1_madd_fadd_32ns_32bkb.h"

namespace ap_rtl {

struct a1_madd : public sc_module {
    ...
    // Module declarations
    a1_madd(sc_module_name name);
    SC_HAS_PROCESS(a1_madd);
    ...
    a1_madd_fadd_32ns_32bkb<1,5,32,32,32>* madd_fadd_32ns_32bkb_U1;
    ...
    sc_signal< sc_lv<21> > indvar_flatten_next_fu_84_p2;
