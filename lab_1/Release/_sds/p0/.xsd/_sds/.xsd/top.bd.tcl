...
connect_bd_net  \
  [get_bd_pins -auto_enable /mmult_1_if/ap_clk] \
  [get_bd_pins -auto_enable /mmult_1/ap_clk] \

connect_bd_net  \
  [get_bd_pins -auto_enable /mmult_1_if/ap_resetn] \
  [get_bd_pins -auto_enable /mmult_1/ap_rst_n] \
...
connect_bd_net  \
  ...
  [get_bd_pins -auto_enable /dm_3/m_axi_s2mm_aclk] \
  [get_bd_pins -auto_enable /madd_1_if/s_axi_aclk] \
  [get_bd_pins -auto_enable /madd_1_if/s_axis_bram_0_aclk] \
  [get_bd_pins -auto_enable /madd_1_if/s_axis_bram_1_aclk] \
  [get_bd_pins -auto_enable /madd_1_if/m_axis_bram_0_aclk] \
  [get_bd_pins -auto_enable /madd_1_if/acc_aclk] \
  [get_bd_pins -auto_enable /mmult_1_if/s_axi_aclk] \
  [get_bd_pins -auto_enable /mmult_1_if/s_axis_bram_0_aclk] \
  [get_bd_pins -auto_enable /mmult_1_if/s_axis_bram_1_aclk] \
  [get_bd_pins -auto_enable /mmult_1_if/m_axis_bram_0_aclk] \
  [get_bd_pins -auto_enable /mmult_1_if/acc_aclk] \
  ...
  [get_bd_pins -auto_enable /axi_ic_ps7_M_AXI_GP0/M04_ACLK] \
  [get_bd_pins -auto_enable /axi_ic_ps7_M_AXI_GP0/M05_ACLK] \
  ...
  [get_bd_pins -auto_enable /axi_ic_ps7_S_AXI_ACP/S03_ACLK] \
  ...
  [get_bd_pins -auto_enable /axis_dwc_dm_3_rx_0/aclk] \
...
connect_bd_net  \
  ...
  [get_bd_pins -auto_enable /axi_ic_ps7_M_AXI_GP0/M04_ARESETN] \
  [get_bd_pins -auto_enable /axi_ic_ps7_M_AXI_GP0/M05_ARESETN] \
  ...
  [get_bd_pins -auto_enable /axi_ic_ps7_S_AXI_ACP/S03_ARESETN] \
...
connect_bd_net  \
  ...
  [get_bd_pins -auto_enable /dm_3/s2mm_prmry_resetn_out_n] \
  [get_bd_pins -auto_enable /madd_1_if/s_axi_aresetn] \
  [get_bd_pins -auto_enable /madd_1_if/s_axis_bram_0_aresetn] \
  [get_bd_pins -auto_enable /madd_1_if/s_axis_bram_1_aresetn] \
  [get_bd_pins -auto_enable /madd_1_if/m_axis_bram_0_aresetn] \
  [get_bd_pins -auto_enable /madd_1_if/acc_aresetn] \
  [get_bd_pins -auto_enable /mmult_1_if/s_axi_aresetn] \
  [get_bd_pins -auto_enable /mmult_1_if/s_axis_bram_0_aresetn] \
  [get_bd_pins -auto_enable /mmult_1_if/s_axis_bram_1_aresetn] \
  [get_bd_pins -auto_enable /mmult_1_if/m_axis_bram_0_aresetn] \
  [get_bd_pins -auto_enable /mmult_1_if/acc_aresetn] \
  ...
  [get_bd_pins -auto_enable /axis_dwc_dm_3_rx_0/aresetn] \
...
connect_bd_net  \
  ...
  [get_bd_pins -auto_enable /axi_ic_ps7_S_AXI_ACP/S02_AXI_arcache] \
  [get_bd_pins -auto_enable /axi_ic_ps7_S_AXI_ACP/S03_AXI_awcache] \
...
connect_bd_intf_net \
  [get_bd_intf_pins -auto_enable /madd_1/A_PORTA] \
  [get_bd_intf_pins -auto_enable /madd_1_if/AP_BRAM_IARG_0_0] \

connect_bd_intf_net \
  [get_bd_intf_pins -auto_enable /madd_1/B_PORTA] \
  [get_bd_intf_pins -auto_enable /madd_1_if/AP_BRAM_IARG_1_0] \

connect_bd_intf_net \
  [get_bd_intf_pins -auto_enable /madd_1/C_PORTA] \
  [get_bd_intf_pins -auto_enable /madd_1_if/AP_BRAM_OARG_0_0] \

connect_bd_intf_net \
  [get_bd_intf_pins -auto_enable /mmult_1_if/ap_ctrl] \
  [get_bd_intf_pins -auto_enable /mmult_1/ap_ctrl] \

connect_bd_intf_net \
  [get_bd_intf_pins -auto_enable /mmult_1/A_PORTA] \
  [get_bd_intf_pins -auto_enable /mmult_1_if/AP_BRAM_IARG_0_0] \

connect_bd_intf_net \
  [get_bd_intf_pins -auto_enable /mmult_1/B_PORTA] \
  [get_bd_intf_pins -auto_enable /mmult_1_if/AP_BRAM_IARG_1_0] \

connect_bd_intf_net \
  [get_bd_intf_pins -auto_enable /mmult_1/C_PORTA] \
  [get_bd_intf_pins -auto_enable /mmult_1_if/AP_BRAM_OARG_0_0] \
...
connect_bd_intf_net \
  ...
  [get_bd_intf_pins -auto_enable /mmult_1_if/S_AXI] \
...
connect_bd_intf_net \
  ...
  [get_bd_intf_pins -auto_enable /madd_1_if/S_AXIS_BRAM_1] \
...
connect_bd_intf_net \
  ...
  [get_bd_intf_pins -auto_enable /mmult_1_if/S_AXIS_BRAM_0] \

connect_bd_intf_net \
  [get_bd_intf_pins -auto_enable /axi_ic_ps7_M_AXI_GP0/M04_AXI] \
...
connect_bd_intf_net \
  ...
  [get_bd_intf_pins -auto_enable /mmult_1_if/S_AXIS_BRAM_1] \

connect_bd_intf_net \
  [get_bd_intf_pins -auto_enable /axi_ic_ps7_M_AXI_GP0/M05_AXI] \
  [get_bd_intf_pins -auto_enable /dm_3/S_AXI_LITE] \

connect_bd_intf_net \
  [get_bd_intf_pins -auto_enable /dm_3/M_AXI_S2MM] \
  [get_bd_intf_pins -auto_enable /axi_ic_ps7_S_AXI_ACP/S03_AXI] \

connect_bd_intf_net \
  [get_bd_intf_pins -auto_enable /madd_1_if/M_AXIS_BRAM_0] \
  [get_bd_intf_pins -auto_enable /axis_dwc_dm_3_rx_0/S_AXIS] \

connect_bd_intf_net \
  [get_bd_intf_pins -auto_enable /axis_dwc_dm_3_rx_0/M_AXIS] \
  [get_bd_intf_pins -auto_enable /dm_3/S_AXIS_S2MM] \

connect_bd_intf_net \
  [get_bd_intf_pins -auto_enable /mmult_1_if/M_AXIS_BRAM_0] \
  [get_bd_intf_pins -auto_enable /madd_1_if/S_AXIS_BRAM_0] \
