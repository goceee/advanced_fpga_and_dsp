...
HD_PWD='C:/Xilinx/workspace_sdx/lab_1/Release/_sds/p0/vivado/prj/prj.runs/zed_proc_sys_reset_4_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zed_proc_sys_reset_4_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zed_proc_sys_reset_4_0.tcl
