...
void a0_madd::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(exitcond_fu_139_p2.read(), ap_const_lv1_0) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()))) {
        sum_cast_reg_183 = sum_cast_fu_156_p1.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state9.read())) {
        tmp_3_reg_208 = grp_fu_107_p2.read();
    }
    if ((esl_seteq<1,1,1>(exitcond1_fu_111_p2.read(), ap_const_lv1_0) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()))) {
...
void a0_madd::thread_ap_done() {
    if ((esl_seteq<1,1,1>(exitcond1_fu_111_p2.read(), ap_const_lv1_1) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()))) {
...
void a0_madd::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        case 1 : 
            ...
            break;
        case 2 : 
            if ((esl_seteq<1,1,1>(exitcond1_fu_111_p2.read(), ap_const_lv1_1) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()))) {
                ap_NS_fsm = ap_ST_fsm_state1;
            } else {
            ...
            break;
        case 4 : 
            if ((esl_seteq<1,1,1>(exitcond_fu_139_p2.read(), ap_const_lv1_1) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()))) {
                ap_NS_fsm = ap_ST_fsm_state2;
            } else {
